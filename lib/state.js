...
class State {
    ...
    save() {
        ...
        logger.debug(json); // Remove after done
    ...
    get(ieeeAddr) {
        let json = JSON.stringify(this.state[ieeeAddr]);
        logger.debug(`Getting state for ${ieeeAddr} - ${json}`); // Remove after done
        // Remove after done
    ...
    set(ieeeAddr, state) {
        ...
        logger.debug(`Saving state for ${ieeeAddr} - ${json}`); // Remove after done
        // Remove after done
    }
